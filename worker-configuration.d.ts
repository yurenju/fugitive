/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 16ce8554a1a863a7afde1d2e632ff488)
...
interface __BaseEnv_Env {
	...
	REPOSITORIES: DurableObjectNamespace<import("./src/index").RepositoryObject>;
	USERS: DurableObjectNamespace<import("./src/index").Users>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RepositoryObject" | "Users";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RESEND_API_URL" | "RESEND_API_KEY" | "EMAIL_FROM" | "REGISTRATION_ALLOWLIST" | "SESSION_SECRET">> {}
}
declare module "*.sh" {
	const value: string;
