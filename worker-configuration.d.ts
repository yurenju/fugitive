/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 80fc112f66bcd491437d694621ef9286)
// Runtime types generated with workerd@1.20260921.1 2026-08-22 nodejs_compat
interface __BaseEnv_Env {
	PACKS: R2Bucket;
	USER_NAME: "yurenju";
	USER_KEY: "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAICvzlUx482dpo0JHKvi7HQsQ/2ecNaj3Lgo4gNH0eEIm claude-agent@fugitive-dev";
	CHALLENGE_SECRET: string;
	REPOSITORY: DurableObjectNamespace<import("./src/index").Repository>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Repository";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "USER_NAME" | "USER_KEY" | "CHALLENGE_SECRET">> {}
}
